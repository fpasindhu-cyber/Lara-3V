...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "3dgFkDYY#QA04SjNIsy8Dt_ejKBo4DCqf-4JMbK88lxCPZd5EJZ0", // Add your session id
PREFIX: process.env.PREFIX || "_",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94771311872",
DEV: process.env.DEV || "94771311872",
